export const menuItems = [
...

  {
    ...
    child: [
      {
        childtitle: "Gerenciamento",
        childlink: "dashboard",
      },
      {
        childtitle: "Cadastrar Instagram",
        childlink: "article",
      },
      {
        childtitle: "Cadastrar Tópicos",
        childlink: "script",
      },
      {
        childtitle: "Criar Agendamento",
        childlink: "instagram",
      },
      {
        childtitle: "Central de Agendamento",
        childlink: "scheduled",
      },
      // {
      //   childtitle: "Central de Automações",
      //   childlink: "dashboard",
      // },
      // {
      //   childtitle: "Whatsapp",
  ...
  //     },
  //     {
  //       childtitle: "Macro Regiões",
  //       childlink: "macro-region",
  //     },
  //     {
  //       childtitle: "Ajuda",
  //       childlink: "#",
